...
interface TooltipPayload<TValue = string | number, TName = string | number> {
  color?: string
...
interface TooltipProps<TValue = string | number, TName = string | number> {
  active?: boolean
  payload?: Array<TooltipPayload<TValue, TName>>
  label?: string
}
...
const ChartTooltipContent = ({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    if (labelFormatter && Array.isArray(payload)) {
